//logic fetch API, ambil data dari API JINKAN. pakai http untuk url dan cahed_image_network untuk imagenya
...
class AnimeRepository {
  ...
  Future<List<Anime>> getTopAnime({int page = 1}) async { //page 1, tiap image ada 25 anime
    try {
